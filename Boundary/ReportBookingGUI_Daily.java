...
public class ReportBookingGUI_Daily extends JFrame implements ActionListener {
    ...
    public ReportBookingGUI_Daily() {
        setTitle("Daily Booking Report");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == generateButton) {
            ...
            // TODO: Perform logic for generating daily booking report using the selected date
               dailyReport = Controller.GenerateReportBookingDailyController.generateReportBookingDailyController(selectedDate);
