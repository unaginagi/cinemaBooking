...
public class DashboardUserAdmin extends JFrame implements ActionListener {
    private JLabel titleLabel;
    private JButton userProfileButton;
    private JButton userAccountButton;
    private JButton logoutButton;

    public DashboardUserAdmin() {
setTitle("Admin User Selection");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == userProfileButton) {
                    ...
                    UserProfileGUI dashboardFrame = new UserProfileGUI();
...
/*
package Boundary;
public class DashboardUserAdmin extends javax.swing.JFrame {
