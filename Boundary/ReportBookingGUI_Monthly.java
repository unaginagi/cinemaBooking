...
public class ReportBookingGUI_Monthly extends JFrame implements ActionListener {
    ...
    public ReportBookingGUI_Monthly() {
        setTitle("Monthly Booking Report");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == generateButton) {
            ...
            String monthlyReport = Controller.GenerateReportBookingMonthlyController.generateReportBookingMonthlyController(selectMonthString,selectYearString);
